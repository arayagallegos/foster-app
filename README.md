...
- [x] **Módulo 0** — Infraestructura base: viewer 3D, carga unificada (el .e57 multi-scan se abre como capas por scan activables, caché de dos resoluciones), recorte por capas que preserva la resolución fina
